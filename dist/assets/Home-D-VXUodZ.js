import{B as M,o,c,m as n,r as d,a as l,b as a,s as I,h as m,_ as z,d as S,F as q,e as B,f as b,u as h,g as f,w as v,i as k,j as P,n as j,t as w}from"./index-CT7DaVJD.js";var A=function(s){var t=s.dt;return`
.p-card {
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const K=p("ZapIcon",[["path",{d:"M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z",key:"1xq2db"}]]),T={class:"min-h-screen bg-gradient-to-br from-purple-400 via-pink-500 to-red-500"},U={class:"container mx-auto px-4 py-16"},_={class:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16"},G={class:"flex items-center justify-center mb-4"},J={class:"text-xl font-bold text-gray-800 text-center"},Q={class:"text-gray-600"},X={class:"flex flex-row gap-3 items-center justify-center"},Y={__name:"Home",setup(e){const s=S([{icon:H,iconColor:"#9333ea",title:"Selección Intuitiva",description:"Su contraseña consistirá en una selección de 5 puntos de una imagen donde el ¡ORDEN IMPORTA!"},{icon:O,iconColor:"#16a34a",title:"Mejor Seguridad",description:"Passpoints tiene un espacio de contraseñas mayor, por lo que su autenticación será más segura sin tener que recordar tediosas y largas contraseñas"},{icon:K,iconColor:"#ca8a04",title:"Fácil de recordar",description:"Passpoints aprovecha la capacidad de tu cerebro para recordar patrones en imágenes, por lo que recordar una contraseña una vez registrada será casi imposible"},{icon:Z,iconColor:"#2563eb",title:"Utilice patrones únicos y personalizados",description:"Seleccione los puntos más sencillos de recordar para usted de la imagen que prefiera"},{icon:E,iconColor:"#dc2626",title:"Resistente a ataques",description:"Passpoints es resistente a ataques comunes en contraseñas alfanuméricas, como ataques de diccionario y fuerza bruta "}]);return(t,i)=>(o(),c("div",T,[a("div",U,[i[0]||(i[0]=a("header",{class:"text-center mb-16"},[a("h1",{class:"text-4xl md:text-6xl font-bold text-white mb-4"}," Implementación de un sistema de autenticación gráfica basado en Passpoints "),a("p",{class:"text-xl text-white opacity-90"}," Seguro, Intuitivo, y Fácil de usar ")],-1)),a("div",_,[(o(!0),c(q,null,B(s.value,r=>(o(),f(h(x),{key:r.title,class:"bg-white bg-opacity-90 hover:bg-opacity-100 transition-all duration-300 p-2 rounded-lg shadow-zinc-300 hover:scale-110"},{header:v(()=>[a("div",G,[(o(),f(P(r.icon),{class:"w-10 h-10",style:j({color:r.iconColor})},null,8,["style"]))]),a("h2",J,w(r.title),1)]),content:v(()=>[a("p",Q,w(r.description),1)]),_:2},1024))),128))]),a("div",X,[b(h(k),{as:"a",href:"https://revistatelematica.cujae.edu.cu/index.php/tele/article/view/970",label:"Aprender mas sobre esta implementación",class:"p-button-lg bg-white text-purple-600 hover:bg-purple-100"}),b(h(k),{as:"router-link",to:{name:"register"},label:"Comenzar a usar el sistema",class:"p-button-lg bg-white text-purple-600 hover:bg-purple-100"})])])]))}},te=z(Y,[["__scopeId","data-v-388f20aa"]]);export{te as default};
