import{B as M,o,c,m as n,r as d,a as l,b as a,s as I,h as m,_ as z,d as S,e as q,F as B,f as P,g as b,u as h,i as f,w as v,j as k,k as j,n as A,t as w}from"./index-Bgk5lw14.js";var N=function(s){var t=s.dt;return`
.p-card {
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Z=({size:e,strokeWidth:s=2,absoluteStrokeWidth:t,color:i,iconNode:r,name:g,class:ee,...$},{slots:y})=>m("svg",{...u,width:e||u.width,height:e||u.height,stroke:i||u.stroke,"stroke-width":t?Number(s)*24/Number(e):s,class:["lucide",`lucide-${R(g??"icon")}`],...$},[...r.map(C=>m(...C)),...y.default?[y.default()]:[]]);/**
 * @license lucide-vue-next v0.460.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const K=p("ZapIcon",[["path",{d:"M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z",key:"1xq2db"}]]),U={class:"min-h-screen bg-gradient-to-br from-purple-400 via-pink-500 to-red-500"},_={class:"container mx-auto px-4 py-16"},G={class:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16"},J={class:"flex items-center justify-center mb-4"},Q={class:"text-xl font-bold text-gray-800 text-center"},X={class:"text-gray-600"},Y={class:"flex flex-row gap-3 items-center justify-center"},W={__name:"Home",setup(e){const s=S([{icon:O,iconColor:"#9333ea",title:"Selección Intuitiva",description:"Su contraseña consistirá en una selección de 5 puntos de una imagen donde el ¡ORDEN IMPORTA!"},{icon:T,iconColor:"#16a34a",title:"Mejor Seguridad",description:"Passpoints tiene un espacio de contraseñas mayor, por lo que su autenticación será más segura sin tener que recordar tediosas y largas contraseñas"},{icon:K,iconColor:"#ca8a04",title:"Fácil de recordar",description:"Passpoints aprovecha la capacidad de tu cerebro para recordar patrones en imágenes, por lo que olvidar una contraseña una vez registrada será casi imposible"},{icon:E,iconColor:"#2563eb",title:"Utilice patrones únicos y personalizados",description:"Seleccione los puntos más sencillos de recordar para usted de la imagen que prefiera"},{icon:H,iconColor:"#dc2626",title:"Resistente a ataques",description:"Passpoints es resistente a ataques comunes en contraseñas alfanuméricas, como ataques de diccionario y fuerza bruta "}]);return(t,i)=>(o(),c("div",U,[a("div",_,[i[0]||(i[0]=a("header",{class:"text-center mb-16"},[a("h1",{class:"text-4xl md:text-6xl font-bold text-white mb-4"},[q(" Implementación del sistema de autenticación gráfica "),a("b",{class:"text-purple-600"}," Passpoints ")]),a("p",{class:"text-xl text-white opacity-90"}," Seguro, Intuitivo, y Fácil de usar ")],-1)),a("div",G,[(o(!0),c(B,null,P(s.value,r=>(o(),f(h(x),{key:r.title,class:"bg-white bg-opacity-90 hover:bg-opacity-100 transition-all duration-300 p-2 rounded-lg shadow-zinc-300 hover:scale-110"},{header:v(()=>[a("div",J,[(o(),f(j(r.icon),{class:"w-10 h-10",style:A({color:r.iconColor})},null,8,["style"]))]),a("h2",Q,w(r.title),1)]),content:v(()=>[a("p",X,w(r.description),1)]),_:2},1024))),128))]),a("div",Y,[b(h(k),{as:"a",href:"https://revistatelematica.cujae.edu.cu/index.php/tele/article/view/970",label:"Aprender mas sobre esta implementación",class:"p-button-lg bg-white text-purple-600 hover:bg-purple-100"}),b(h(k),{as:"router-link",to:{name:"register"},label:"Comenzar a usar el sistema",class:"p-button-lg bg-white text-purple-600 hover:bg-purple-100"})])])]))}},ae=z(W,[["__scopeId","data-v-97653df0"]]);export{ae as default};
